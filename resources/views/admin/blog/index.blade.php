                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">All Blog</strong>
                               <input type="text" placeholder="Search .." id="myInput" class="form-control col-md-3  float-right">
                                ...
                                <table class="table ">
                                    ...
                                    @if($blog->status == "PUBLISH")
                                        <tr>
                                            ...
                                            <td class="text-center"> <span class="">{{$blog->created_at->format('d M')}}</span> </td>
                                            <td class="text-center"><span >
                                            <form action="{{route('blog.destroy',$blog->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger fa fa-times" onclick="return confirm('Are you sure?')"></button>
                                                <a href="{{route('blog.show',$blog->id)}}" class="btn fa fa-eye"></a>
                                                <a href="{{route('blog.edit',$blog->id)}}" class="btn btn-primary fa fa-edit"></a>
                                            </form>
                                            </span></td>
                                            <td class="text-center">
                                                <span class="badge badge-complete">{{$blog->status}}</span>
