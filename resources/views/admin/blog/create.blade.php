                    ...
                    <style>
                      #cke_1_contents{
                                ...
                                <div class="accordion" id="accordionExample">
                                  <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                      <div class="card-body">
                                        <textarea name="text2" id="text2" rows="10" cols="80" required="">
                        ...
                        <div class="row">
                            ...
                            <input type="file" id="profile-img" required name="img1" class="form-control"><br>

                            <label for="" class="form-control-label">Image 2</label>
                            <input type="file" id="" name="img2" class="form-control"><br>
                            
                            <select name="category" id="" data-placeholder="Category ..."  class="standardSelect form-control" tabindex="1" required>
                        ...
                        <input type="text" name="writer" hidden="" value="{{ auth()->user()->name}}">
                        <div class="">
