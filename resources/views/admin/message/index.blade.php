                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">All Message</strong>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($messages as $message)
                                         <tr>
                                            ...
                                            <td>  <span class="name">{{$message->subject}}</span> </td>
                                            <td class="text-center"> <span class="">{{$message->created_at->format('d M')}}</span> </td>
                                            <td class="text-center"><span >
                                            <form action="{{route('message.destroy',$message->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger fa fa-times" onclick="return confirm('Are you sure?')"></button>
                                                <a href="{{route('message.show',$message->id)}}" class="btn fa fa-eye"></a>
                                            </form>
                                            </span></td>
                                        </tr>
                                        @endforeach
